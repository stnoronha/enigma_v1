...
def fetch_ahba(csvfile=None):
    ...
    if csvfile is None:
        ...
        return pd.read_csv(csvfile, on_bad_lines = 'warn')
...
def load_example_data():
    ...
    return pd.read_csv(cov, on_bad_lines = 'warn'), \
           pd.read_csv(metr1, on_bad_lines = 'warn'), \
           pd.read_csv(metr2, on_bad_lines = 'warn'), \
           pd.read_csv(metr3, on_bad_lines = 'warn')
...
def load_summary_stats(disorder=None):
    ...
    if disorder == "22q":
        ...
        CortThick_case_controls_adult = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_CortThick_adult.csv'), on_bad_lines = 'warn')
        CortSurf_case_controls_adult = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_CortSurf_adult.csv'), on_bad_lines = 'warn')
        CortThick_typeI_typeII_adult = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_typeI-typeII_CortThick_adult.csv'), on_bad_lines = 'warn')
        CortSurf_typeI_typeII_adult = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_typeI-typeII_CortSurf_adult.csv'), on_bad_lines = 'warn')
        CortThick_case_controls_adolescent = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_CortThick_adolescent.csv'), on_bad_lines = 'warn')
        CortSurf_case_controls_adolescent = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_CortSurf_adolescent.csv'), on_bad_lines = 'warn')
        CortThick_typeI_typeII_adolescent = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_typeI-typeII_CortThick_adolescent.csv'), on_bad_lines = 'warn')
        CortSurf_typeI_typeII_adolescent = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_typeI-typeII_CortSurf_adolescent.csv'), on_bad_lines = 'warn')
        SubVol_case_controls_typeI = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_SubVol_typeI.csv'), on_bad_lines = 'warn')
        SubVol_case_controls_typeII = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_case-controls_SubVol_typeII.csv'), on_bad_lines = 'warn')
        SubVol_typeII_typeI = pd.read_csv(
            os.path.join(root_pth, 'summary_statistics', 'bd_typeII-typeI_SubVol.csv'), on_bad_lines = 'warn')
        ...
        SubVol_case_vs_controls = pd.read_csv(os.path.join(root_pth, 'summary_statistics',
                                                           'mdd_case-controls_SubVol.csv'), on_bad_lines = 'warn')
        ...
        CortThick_case_controls = pd.read_csv(os.path.join(root_pth, 'summary_statistics',
                                                          'scz_case-controls_CortThick.csv'), on_bad_lines = 'warn')
        CortSurf_case_controls = pd.read_csv(os.path.join(root_pth, 'summary_statistics',
                                                          'scz_case-controls_CortSurf.csv'), on_bad_lines = 'warn')
        SubVol_case_controls = pd.read_csv(os.path.join(root_pth, 'summary_statistics',
                                                           'scz_case-controls_SubVol.csv'), on_bad_lines = 'warn')
        SubVol_case_controls_mean = pd.read_csv(os.path.join(root_pth, 'summary_statistics',
                                                          'scz_case-controls_SubVol_mean.csv'), on_bad_lines = 'warn')
...
def reorder_sum_stats(in_file, out_file):
    ...
    """
    # Load in_fil
    in_file = pd.read_csv(in_file, on_bad_lines = 'warn')
